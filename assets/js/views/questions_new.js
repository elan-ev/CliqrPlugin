  ...
  define(['views/template_view', 'views/questions_form'], function(TemplateView, QuestionsForm) {
    ...
    return QuestionsNewView = (function(_super) {
      ...
      function QuestionsNewView() {
        QuestionsNewView.__super__.constructor.apply(this, arguments);
      }
      ...
      QuestionsNewView.prototype.postRender = function() {
        return this.form.postRender();
      };

      QuestionsNewView.prototype.remove = function() {
        this.form.remove();
        return QuestionsNewView.__super__.remove.call(this);
      };
