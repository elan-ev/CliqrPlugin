...
<html lang="en">
    ...
    <body>
        ...
        <? if (defined('WDS_ACTIVATED') && constant('WDS_ACTIVATED')) { ?>
            <link charset="utf-8" href="https://localhost:8081/polls.css" rel="stylesheet" media="screen, print">
            <script charset="utf-8" src="https://localhost:8081/polls.js"></script>
        <? } else { ?>
            <link charset="utf-8" href="<?= $PLGNURL ?>/static/polls.css" rel="stylesheet" media="screen, print">
